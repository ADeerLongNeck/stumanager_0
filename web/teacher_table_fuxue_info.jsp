    ...
    <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="teacher_fuxue.jsp"><i class="fa fa-qrcode"></i>复学管理</a>
                </li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="teacher_table_fuxue_info.jsp" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>申请原因</label>
                                            <input id="sqyy"  name="sqyy" class="form-control"  value="<%= fuXue.getSqyy() %>">
                                        ...
                                        <div class="form-group">
                                            <label>审核人</label>
                                            <input id="shren"  name="shren" class="form-control"  value="<%= fuXue.getShren() %>">

                                        </div>
                                        <div class="form-group">
                                            <label>审核人备注</label>
                                            <input id="shbz"  name="shbz" class="form-control"  value="<%= fuXue.getShbz() %>">
